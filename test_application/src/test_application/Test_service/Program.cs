    ...
    public static class Program
    {
        public static void Main(string[] args)
        {
            try
            {
                ...
                ServiceEventSource.Current.Message("Registering Service : {0}", "Test_service");

                ServiceRuntime.RegisterServiceAsync("Test_serviceType",
                    context => new Test_service (context)).GetAwaiter().GetResult();

                ServiceEventSource.Current.Message("Registered Service : {0}", "Test_service");
